import De, { useRef as O, useEffect as M, createContext as ne, useState as q, useContext as z, useCallback as ke, useMemo as br, useReducer as Er, Children as Tr, isValidElement as Pr } from "react";
var te = { exports: {} }, I = {};
/**
 * @license React
...
function _r() {
  if (je)
    return I;
  je = 1;
  var n = De, a = Symbol.for("react.element"), i = Symbol.for("react.fragment"), c = Object.prototype.hasOwnProperty, l = n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, d = { key: !0, ref: !0, __self: !0, __source: !0 };
  function h(b, u, E) {
    var y, g = {}, m = null, $ = null;
    E !== void 0 && (m = "" + E), u.key !== void 0 && (m = "" + u.key), u.ref !== void 0 && ($ = u.ref);
    for (y in u)
      c.call(u, y) && !d.hasOwnProperty(y) && (g[y] = u[y]);
    if (b && b.defaultProps)
...
function Cr() {
  return Ae || (Ae = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function ze(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === c || e === d || qe || e === l || e === E || e === y || Ve || e === $ || Ue || Be || Ne || typeof e == "object" && e !== null && (e.$$typeof === m || e.$$typeof === g || e.$$typeof === h || e.$$typeof === b || e.$$typeof === u || // This needs to include all possible module reference object
...
`), C = o.stack.split(`
`), T = s.length - 1, P = C.length - 1; T >= 1 && P >= 0 && s[T] !== C[P]; )
            P--;
          for (; T >= 1 && P >= 0; T--, P--)
            if (s[T] !== C[P]) {
              if (T !== 1 || P !== 1)
...
` + s[T].replace(" at new ", " at ");
        ...
        H = !1, J.current = p, He(), Error.prepareStackTrace = v;
      }
    ...
    function Qe(e, r, t, o, v) {
      {
        ...
        for (var f in e)
          if (p(e, f)) {
            ...
            s && !(s instanceof Error) && (V(v), _("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", o || "React class", t, f, typeof s), V(null)), s instanceof Error && !(s.message in ye) && (ye[s.message] = !0, V(v), _("Failed %s type: %s", t, s.message), V(null));
          }
      }
    }
    ...
    function Ee(e) {
      if (tr(e))
        return _("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", rr(e)), be(e);
    }
    ...
    function lr(e, r, t, o, v) {
      {
        var p, f = {}, s = null, C = null;
        t !== void 0 && (Ee(t), s = "" + t), or(r) && (Ee(r.key), s = "" + r.key), ar(r) && (C = r.ref, ir(r, v));
        for (p in r)
        ...
        return cr(e, s, C, v, o, L.current, f);
      }
    }
    ...
    function Re(e, r) {
      {
        ...
        we[t] = !0;
        var o = "";
        e && e._owner && e._owner !== Z.current && (o = " It was passed a child from " + R(e._owner.type) + "."), j(e), _('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, o), j(null);
      }
    }
    function xe(e, r) {
      {
    ...
    function Oe(e, r, t, o, v, p) {
      {
        ...
        if (!f) {
          ...
          C ? s += C : s += Ce();
          var T;
          e === null ? T = "null" : K(e) ? T = "array" : e !== void 0 && e.$$typeof === a ? (T = "<" + (R(e.type) || "Unknown") + " />", s = " Did you accidentally export a JSX literal instead of a component?") : T = typeof e, _("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", T, s);
        }
        var P = lr(e, r, t, v, p);
        if (P == null)
          return P;
...
process.env.NODE_ENV === "production" ? te.exports = _r() : te.exports = Cr();
var D = te.exports;
const re = "mekuri-transitioning", wr = ({
  trigger: n,
  setMekuriState: a,
  millisecond: i
}) => {
  ...
  M(() => {
    ...
    })), document.documentElement.classList.add(re), d = setTimeout(() => {
  ...
  new IntersectionObserver(
    (l, d) => {
      l.forEach((h) => {
        a(h.isIntersecting), d.unobserve(h.target);
      });
    },
  ...
  i.forEach((d) => {
    jr(d.href) ? l() : d.addEventListener("load", l, {
      once: !0
    });
  });
}, $r = ({
  ...
  M(() => {
    ...
    }) : a && a(m))), u.phase === "enter" && (d && d(m), E === "wait" && g && i && i(m), E === "sync" && (g && y && u.isPopstate && i && i(m), c && c(m)));
  }, [u]);
}, Wr = (n) => {
  ...
  const i = O(!0), c = typeof a == "object" && "scrollRestoration" in a, l = O({
    backPosY: 0,
    keysArr: []
  }), d = c && !a.onEnter && a.onLeave, h = O(d ? "leave" : "enter"), b = ke(
    (E) => {
      const y = h.current === E, g = y && d;
      return Dr({
        isCacheUpdate: y,
